...
library(readr)
library(ggplot2)
apr14 <- read.csv("E:/Datasets/Uber/uber-raw-data-apr14.csv")
may14 <- read.csv("E:/Datasets/Uber/uber-raw-data-may14.csv")
jun14 <- read.csv("E:/Datasets/Uber/uber-raw-data-jun14.csv")
jul14 <- read.csv("E:/Datasets/Uber/uber-raw-data-jul14.csv")
aug14 <- read.csv("E:/Datasets/Uber/uber-raw-data-aug14.csv")
sep14 <- read.csv("E:/Datasets/Uber/uber-raw-data-sep14.csv")
...
monthly_growth <- month_borough_14 %>%
  ...
  ggplot(aes(Month, n, colour = Borough)) + geom_point() +
